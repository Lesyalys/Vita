...
document.querySelector('#header h1').innerHTML = `
      ...
      <ul>
        ...
        <li class="underHearUl"><p id="underHeader"><a href = "nya.olesya@bk.ru" target ="_blank">nya.olesya@bk.ru</a></p></li>
      </ul>

      <ul>
        <li class="underHearUl"><p id="underHeader">tg:</p></li>
        <li class="underHearUl"><p id="underHeader"><a href = "https://t.me/Shadowtav" target ="_blank">@Shadowtav</a></p></li>
      </ul>
      `
